@wait huh? i thought I already made a docker container already that way it would work on my windows pc lol why you do all that??? did you just add new stuff but not delete anything right? or what the f did you just do lol also i gotta give you my google app password so you can setup emails right
Here is my name, Adam Capuana
Here is my email adamb.capuana@gmail.com
Here is the email you will send notifications to 7329957580@vtext.com
Here is my google app password zczq xbiu hbrg wvedwait huh? i thought I already made a docker container already that way it would work on my windows pc lol why you do all that??? did you just add new stuff but not delete anything right? or what the f did you just do lol also i gotta give you my google app password so you can setup emails right
Here is my name, Adam Capuana
Here is my email adamb.capuana@gmail.com
Here is the email you will send notifications to 7329957580@vtext.com
Here is my google app password zczq xbiu hbrg wvedecho off
