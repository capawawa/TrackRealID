...
Here is my email [REDACTED_EMAIL]
Here is the email you will send notifications to [REDACTED_RECIPIENT]
Here is my google app password [REDACTED_APP_PASSWORD]wait huh? i thought I already made a docker container already that way it would work on my windows pc lol why you do all that??? did you just add new stuff but not delete anything right? or what the f did you just do lol also i gotta give you my google app password so you can setup emails right
Here is my name, Adam Capuana
Here is my email [REDACTED_EMAIL]
Here is the email you will send notifications to [REDACTED_RECIPIENT]
Here is my google app password [REDACTED_APP_PASSWORD]echo off
