...
1. Configure your `.env` file with your email credentials:
   ...
   TRACKER_EMAIL_SENDER=[REDACTED_EMAIL]
   TRACKER_EMAIL_RECIPIENT=[REDACTED_RECIPIENT]
   TRACKER_EMAIL_PASSWORD=[REDACTED_APP_PASSWORD]
   ```
...
- `TRACKER_EMAIL_SENDER`: Gmail address to send notifications from (already set to [REDACTED_EMAIL])
- `TRACKER_EMAIL_RECIPIENT`: Email address to receive notifications (already set to [REDACTED_RECIPIENT])
